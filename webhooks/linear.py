...
async def _process_linear_issue(
    ...
    prompt_parts.extend([
        ...
        "   - State that a fresh-context self-review is running and its verdict",
        "     will be posted here as a follow-up comment",
        "",
        ...
        "",
        "   :mag: A fresh-context self-review of this PR is running \u2014 the verdict",
        "   will be posted here as a follow-up comment. Wait for it before reviewing.",
        "",
...
async def _process_linear_comment_on_existing(
    ...
    prompt_parts = [
        ...
        "",
        "   :mag: A fresh-context self-review of the new commits is running \u2014 the",
        "   verdict will be posted here as a follow-up comment.",
        "",

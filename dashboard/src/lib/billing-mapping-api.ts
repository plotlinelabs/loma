...
export async function fetchBillingMappings(): Promise<BillingOrganization[]> { return (await request<{organizations: BillingOrganization[]}>("/api/billing-mappings")).organizations; }

  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto">
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        <div className="pwa-header-offset">
          <h1 className="text-lg font-semibold text-foreground">API Keys</h1>
          <p className="text-sm text-muted-foreground mt-1">
            Personal keys for connecting external agents to your Loma tasks over
        ...
        <Card>
          <CardContent className="p-4 space-y-2">
            <div className="text-sm font-medium text-foreground">MCP endpoint</div>
        ...
        <Card>
          <CardContent className="p-4 space-y-3">
            <div className="text-sm font-medium text-foreground">Create a key</div>
            <div className="flex items-center gap-2">
              <Input
                value={name}

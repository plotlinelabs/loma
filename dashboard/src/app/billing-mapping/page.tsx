...
export default function BillingMappingPage() {
  ...
  async function load(page = pagination.page) {
    ...
    try { const result = await fetchBillingMappings(page, pagination.pageSize); const rows = result.organizations; setOrganizations(rows); setPagination(result.pagination); setAccountValues(Object.fromEntries(rows.map(o => [o.id, o.monetizeNowAccountId || ""]))); }

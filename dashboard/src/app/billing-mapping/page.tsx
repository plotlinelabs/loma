...
const labels: Record<BillingStatus, string> = { correctly_linked: "Correct", contract_missing: "Missing contract", invalid_contract: "Invalid contract", inactive_contract: "Inactive contract", account_mismatch: "Account mismatch", account_not_linked: "Account not linked", unknown: "Needs recheck" };
const colors: Record<BillingStatus, string> = { correctly_linked: "bg-emerald-50 text-emerald-700", contract_missing: "bg-amber-50 text-amber-700", invalid_contract: "bg-red-50 text-red-700", inactive_contract: "bg-red-50 text-red-700", account_mismatch: "bg-orange-50 text-orange-700", account_not_linked: "bg-slate-100 text-slate-700", unknown: "bg-violet-50 text-violet-700" };
